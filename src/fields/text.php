    ...
    class Field_text extends Field
    {
        public function render()
        {
            ...
            if(!empty($this->getId())) {
                ...
                echo '<input type="text" id="' . esc_attr($this->getId()) . '" name="' . esc_attr($name) . '" ' . esc_attr($required) . esc_attr($placeholder) . ' value="' . esc_attr($this->getValue()) . '">';
